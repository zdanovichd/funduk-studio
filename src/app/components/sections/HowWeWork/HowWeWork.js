...
export default function HowWeWorkSlider({
    ...
    return (
        <section className={styles.howwework}>
            <div
                className={styles.howwework__wrapper}
                style={{ paddingLeft: leftPadding + "px" }}
            >
                <div className={styles.howwework__inner}>
                    <div className={styles.howwework__content}>
                        <h2 className={styles.howwework__title}>{title}</h2>
                        <p className={styles.howwework__description}>
                            {description}
                        </p>
                    </div>
                    <div className={styles.howwework__buttons}>
                        <button
                ...
                <div className={styles.howwework__inner}>
                    ...
                    >
                        {slides.map((content, index) => (
                            <SwiperSlide
                                key={index}
                                className={`${styles.howwework__item} ${(index+1) % 2 === 0 ? styles.howwework__item_even : styles.howwework__item_odd }`}
                            >
                ...
                <div className={styles.howwework__inner}>
                    ...
                    <div className={styles.howwework__buttons_mobile}>
                        <button
                            onClick={() => swiperRef.current.slidePrev()}
                            className={styles.howwework__button}
                            title="Назад"
