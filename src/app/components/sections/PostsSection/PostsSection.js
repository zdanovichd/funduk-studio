...
export default function PostsSection({
    ...
    return (
        <section className={styles.postssection}>
            <div
                className={styles.postssection__wrapper}
                style={{ paddingLeft: leftPadding + "px" }}
            >
                <div className={styles.postssection__inner}>
                    <div className={styles.postssection__content}>
                        <h2 className={styles.postssection__title}>{title}</h2>
                    </div>
                    <div className={styles.postssection__content_bottom}>

                        <Link className={styles.postssection__link} href="/blog">Перейти ко всем статьям →</Link>
                        <div className={styles.postssection__buttons}>
                            <button
                                onClick={() => swiperRef.current.slidePrev()}
                                className={styles.postssection__button}
                                title="Назад"
                            >
                ...
                <div className={styles.postssection__inner}>
                    <Swiper
                        className="postssection__slider"
                        // modules={[Navigation]}
                        loop={true}
                        onSwiper={(swiper) => {
                ...
                <div className={styles.postssection__inner}>
                    ...
                    <div className={styles.postssection__buttons_mobile}>
                        <button
                            onClick={() => swiperRef.current.slidePrev()}
                            className={styles.postssection__button}
                            title="Назад"
