...
export default function Home() {
  ...
  return (
    <main>
      ...
      />
      <WhyUsSection
        title = "Дизайн и&nbsp;ремонт квартир от&nbsp;компании &quot;Фундук&quot;"
        topData = "<p>Студия &laquo;Фундук&raquo; специализируется на дизайне и <a href='/otdelka-kvartir'><span>отделке квартир</span></a> в Санкт-Петербурге, обеспечивая высокое качество работ за разумную цену. Наше предложение включает в себя все этапы работ: от разработки проекта до финишной <span>отделки квартиры под ключ</span>. Команда опытных профессионалов выполняет задачи оперативно, применяя материалы премиум-класса. Прозрачное формирование цен и персонализированный подход к каждому клиенту позволяют точно соответствовать финансовым ожиданиям заказчика.</p><p>В городе на Неве разнообразие жилых форматов велико: от современных высоток до уникальных сталинских домов и частных домовладений. Различные планы и состояние помещений зачастую требуют от владельцев внесения изменений, будь то легкий косметический ремонт или полноценное преображение интерьера.</p>"
        bottomData = "<p>Рассмотрим ключевые этапы <b>ремонта квартир в СПб</b>:</p><ul><li><b>Демонтажные работы.</b>&nbsp;Подготовка поверхностей и структур к возможным изменениям планировки и замене устаревших элементов, особенно если речь идет о старых домах. Время на выполнение может занимать от пары дней до двух недель в зависимости от сложности.</li><li><b>Черновая отделка и монтаж инженерных сетей</b>. На данном этапе производится выравнивание поверхностей, строительство перегородок, прокладка электрики и сантехнических коммуникаций, формирование дверных проемов. Также проводится облицовка стен штукатуркой или гипсокартоном и устройство стяжки пола. Эта фаза может занять до половины общего времени работ.</li><li><b>Промежуточная внутренняя отделка квартиры</b>. На этом этапе начинается видимое обновление жилища: заливка полов, монтаж лаг, шпатлевка стен и потолков. В ванной комнате и санузле укладывается плитка. Этот процесс может занимать около 25% от общего времени проекта.</li><li><b>Чистовая отделка квартиры. </b>Создание основы для комфортабельного проживания уже позади, остается лишь придать помещению завершенный вид. Установка дверей, сантехники, электрофурнитуры и светильников идут первыми. Некоторые работы могут выполняться одновременно, но, к примеру, укладка напольных покрытий рекомендуется после завершения всех малярных работ. В финале производится покраска стен или поклейка обоев и укладка пола.</li></ul><h3>Виды ремонтных работ</h3><p>Мы внимательно прислушиваемся к требованиям и пожеланиям наших клиентов, поэтому в рамках услуг <b>отделки помещений под ключ</b> от нашей компании вы найдете различные варианты на выбор:</p><ul><li><a href='/remont-kvartir/kosmeticheskiy'><span>косметический ремонт</span></a>&nbsp;&ndash; исправление недочетов, обновление отделочных материалов, замена обоев и плинтусов. Является наиболее бюджетным вариантом;</li><li><a href='/remont-kvartir/kapitalnyy'><span>капитальный</span></a> &ndash; масштабная замена инженерных систем, новое напольное и потолочное покрытие, монтаж плитки в санузлах и прочее;</li><li><a href='/remont-kvartir/dizaynerskiy'><span>дизайнерский ремонт</span></a>&nbsp;&ndash; разработка индивидуального проекта с учетом всех деталей: от расстановки мебели до выбора стиля интерьера.</li></ul><p><b>Сколько стоит отделка квартиры</b> &ndash; вопрос, на который мы готовы дать ответы, предоставив подробную смету после оценки объема и сложности работ. Чтобы клиент мог визуализировать будущий интерьер, наши дизайнеры предлагают 3D-проект, который демонстрирует все идеи <b>отделки квартиры </b>и обоснование<b> цены</b>. Есть возможность внести корректировки в план до начала работ. Реализация проекта начинается только после утверждения заказчиком.</p>"
      />
